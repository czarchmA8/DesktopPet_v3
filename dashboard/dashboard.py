...
class ControlWindow(QtWidgets.QWidget):
    ...
    def setup_settings_ui(self):
        ...
        for key, label in app_hotkeys_cfg:
            ...
            self.translator.tr(lambda btn_set=btn_set: btn_set.setText(self.translate("Settings", "Set", None)))
            btn_set.clicked.connect(lambda _, c=category, k=key: self.set_app_hotkey(c, k))
            btn_rem = QtWidgets.QPushButton()
            self.translator.tr(lambda btn_rem=btn_rem: btn_rem.setText(self.translate("Settings", "Delete", None)))
